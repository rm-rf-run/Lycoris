...
class Options_Framework_Admin {
	...
	function enqueue_admin_styles( $hook ) {
		...
		wp_enqueue_style( 'optionsframework', 'https://cdn.jsdelivr.net/gh/rm-rf-run/jasmine/inc/css/optionsframework.css', array(),  Options_Framework::VERSION );
	...
	function enqueue_admin_scripts( $hook ) {
		...
		wp_enqueue_script(
			'options-custom',
			'https://cdn.jsdelivr.net/gh/rm-rf-run/jasmine/inc/js/options-custom.js',
